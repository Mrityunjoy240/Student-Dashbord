        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] flex flex-col justify-between">
          ...
          <div className="flex justify-between items-center border-t border-gray-100 pt-6 mt-6">
            <div className="flex items-center gap-2">
               ...
               <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{userGoal?.targetDate.toLocaleDateString()}</p>
            </div>
            <EditGoalModal 
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] flex flex-col justify-between">
          ...
          <div className="flex justify-between items-center border-t border-gray-100 pt-6 mt-6">
            <div className="flex flex-col">
              ...
              <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Target: {exam?.targetDate.toLocaleDateString()}</p>
            </div>
            <EditExamModal 
